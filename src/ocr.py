...
def extract(
    ...
    """
    Run the notebook-equivalent OCR pipeline.
    ...
    file_path:
        PDF/image path.
    refine:
        If True, use Gemini page-by-page after local OCR.
    output_dir:
        Optional directory for raw_ocr.json, raw_ocr.txt and
        formatted_document.txt.
